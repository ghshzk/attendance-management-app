...
<div class="attendance-list-container">
    <h3 class="list-heading">勤怠一覧</h3>
    <div class="list-month-nav">
        <a class="month-link" href="{{ route('attendance.index', ['month' => $month->copy()->subMonth()->format('Y-m-01')]) }}">
        ...
        <a class="month-link" href="{{ route('attendance.index', ['month' => $month->copy()->addMonth()->format('Y-m-01')]) }}">
